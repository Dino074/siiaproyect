...
Module conexionBD
    ...
    Public conexion As New SqlConnection("data source= PC-DE-MANU074; initial catalog= siia_uadec; integrated security= SSPI; persist security info= false; trusted_connection = yes;")
