...
Module conexionBD
    ...
    Public conexion As New SqlConnection("data source= ; initial catalog= siia_uadec; integrated security= SSPI; persist security info= false; trusted_connection = yes;")
